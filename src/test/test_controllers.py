...
class TestCategory(unittest.TestCase):
    ...
    #     mock_query.filter_by.return_value.first.return_value = ProductResource(
    #         id=1, name="Product 1", price=100.0, description="A great product", stock=10,
    #         category_id=self.category_id, brand_id=self.brand_id, img="http://example.com/image.jpg"
    #     )
...
#         """Probar que faltando campos obligatorios devuelve un error."""
#         data = {
#             "price": 100.0,
#             "description": "A great product",
#             "stock": 10,
...
#         self.assertEqual(response.status_code, 400)
#         self.assertIn("Name is required and should be a valid string", response.get_data(as_text=True))

# def test_invalid_price(self):
#         """Probar que si el precio es negativo, retorna un error."""
#         data = {
#             "name": "Product 2",
#             "price": -50.0,
...
#         self.assertEqual(response.status_code, 400)
#         self.assertIn("Price must be greater than 0", response.get_data(as_text=True))

# def test_invalid_stock(self):
#         """Probar que si el stock es negativo, retorna un error."""
#         data = {
#             "name": "Product 3",
#             "price": 50.0,
...
#         self.assertEqual(response.status_code, 400)
#         self.assertIn("Stock cannot be negative", response.get_data(as_text=True))

# def test_invalid_image_url(self):
#         """Probar que si la URL de la imagen no es válida, retorna un error."""
#         data = {
#             "name": "Product 4",
#             "price": 60.0,
#             "description": "A product with invalid image URL",
#             "stock": 10,
#             "category_id": self.category_id,
#             "brand_id": self.brand_id,
#             "img": "ftp://example.com/image.jpg"  # URL no válida
#         }
        
#         response = self.client.post('/products', json=data)

#         self.assertEqual(response.status_code, 400)
#         self.assertIn("Image URL must start with 'http://' or 'https://'", response.get_data(as_text=True))
